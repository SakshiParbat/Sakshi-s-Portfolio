          ...
          >
            ...
            >
              ...
              <div className="flex items-center space-x-6">
                {/* School Logo/Image */}
                <div className="w-25 h-25 bg-white rounded-md overflow-hidden flex items-center justify-center">
                  <img
                    src={edu.img}
                    alt={edu.school}
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    <h3 className="text-lg font-semibold sm:text-sm text-gray-300">
                      {edu.degree}
                    </h3>
